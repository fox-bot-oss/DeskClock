...
public class AlarmUtils {
    ...
    public static String formatElapsedTimeUntilAlarmLabel(Context context, long delta) {
        // If the alarm will ring within 60 seconds, just report "less than a minute."
        final String[] formats = context.getResources().getStringArray(R.array.alarm_in_future);
        if (delta < DateUtils.MINUTE_IN_MILLIS) {
            return formats[0];
        }
