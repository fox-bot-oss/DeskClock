...
public final class Weekdays {
    ...
    private static final int MON_TO_WED = 0x07;
    private static final int TUES_TO_THUR = 0x0E;
    private static final int WED_TO_FRI = 0x1C;
    private static final int THUR_TO_SAT = 0x38;
    private static final int FRI_TO_SUN = 0x70;

    private static final int MON_TO_THUR = 0x0F;
    private static final int TUES_TO_FRI = 0x1E;
    private static final int WED_TO_SAT = 0x3C;
    private static final int THUR_TO_SUN = 0x78;

    private static final int MON_TO_FRI = 0x1F;
    private static final int TUES_TO_SAT = 0x3E;
    private static final int WED_TO_SUN = 0x7C;

    private static final int MON_TO_SAT = 0x3F;
    private static final int TUES_TO_SUN = 0x7E;
