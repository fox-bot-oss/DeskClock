...
public abstract class AlarmItemViewHolder extends ItemAdapter.ItemViewHolder<AlarmItemHolder>
    ...
    protected void bindRepeatText(Context context, Alarm alarm) {
        String inFuture = alarm.enabled ? " | " + AlarmUtils.formatElapsedTimeUntilAlarmLabel(context, alarm.getNextAlarmTime(
        ...
        if (alarm.daysOfWeek.isRepeating()) {
            ...
            String labelText = Alarm.isTomorrow(alarm, Calendar.getInstance()) ?
